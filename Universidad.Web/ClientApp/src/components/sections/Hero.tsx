    ...
    return (
        <section className="relative -mt-[72px] flex h-[clamp(480px,80vh,720px)]">
            ...
            <div className="relative z-[2] flex max-w-[760px] flex-col justify-center px-[clamp(20px,6vw,72px)] pt-24">
                <div className="mb-6 inline-flex w-fit items-center gap-2 rounded-full bg-fq-primary/90 px-3.5 py-1.5 text-[13px] font-bold text-white">
                    Inscripciones abiertas 2027
                </div>
                <h1 className="mb-5 text-display font-extrabold leading-[1.05] text-white">
                    Estudiá química en la universidad pública
                </h1>
                <p className="mb-8 max-w-[520px] text-lg leading-[1.55] text-white/90">
