...
const NAV_SECTIONS: NavSection[] = [
    ...
    },
    {
        ...
        icon: GraduationCap,
        links: [
            { label: 'Bedelía', href: '/bedelia' },
            { label: 'Carreras', href: '/carreras' },
            { label: 'Futuros estudiantes', href: '/futuros-estudiantes' },
            ...
            { label: 'Aulas virtuales', href: '/aulas-virtuales' },
            { label: 'Apoyo al estudiante', href: '/apoyo-estudiante' },
            { label: 'Educación permanente', href: '/educacion-permanente-estudiantes' },
        ],
    },
    {
        label: 'Funcionarios',
        ...
        links: [
            ...
            { label: 'Funcionarios TAS', href: '/funcionarios-tas' },
    ...
    },
    {
        ...
        icon: Award,
        links: [
            { label: 'Educación permanente', href: '/educacion-permanente-egresados' },
            { label: 'Unidad de inserción laboral', href: '/insercion-laboral-egresados' },
        ],
    },
    {
        label: 'Empresas',
        icon: Building2,
        links: [
            { label: 'Educación permanente', href: '/educacion-permanente-empresas' },
            { label: 'Asesoramiento', href: '/asesoramiento' },
            { label: 'Unidad de inserción laboral', href: '/insercion-laboral-empresas' },
        ],
    },
];
