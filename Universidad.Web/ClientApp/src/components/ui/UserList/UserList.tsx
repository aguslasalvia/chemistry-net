...
const UserList: React.FC<UserListProps> = ({ users, onEdit, onDelete, onChangePassword }) => {
        ...
        <div className="user-list">
            ...
            {filteredUsers.length === 0 ? (
                <div className="user-list__empty">
                    <p>{search ? 'No se encontraron usuarios' : 'No hay usuarios creados'}</p>
                    <span>
                        {search ? 'Intenta con otros términos de búsqueda' : 'Crea tu primer usuario usando el formulario'}
                    </span>
                </div>
            ) : (
