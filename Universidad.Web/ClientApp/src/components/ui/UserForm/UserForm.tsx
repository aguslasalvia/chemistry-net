...
const UserForm: React.FC<UserFormProps> = ({ onSubmit, loading = false, onCancel }) => {
        ...
        <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
            <div className="flex flex-col gap-2">
                ...
                <div className="relative flex items-start">
                    <User className="pointer-events-none absolute top-3.5 left-3.5 text-fq-muted" size={18} />
                    <input
                        id="firstName"
                        type="text"
